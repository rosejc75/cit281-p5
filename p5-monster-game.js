...
module.exports = class MonsterGame {
  ...
  listMonsters() {
    for (const monster of this.monsters) {
      const {monsterName, minimumLife, isAlive, currentLife} = monster;
      console.log(`Monster Name: ${monsterName}, Minimum Life: ${minimumLife}, Is Alive: ${isAlive}, Current Life: ${currentLife}`);
    }
  }
